...
- **Privacy-Preserving AI-Assisted Content (🔵)**: The document includes sections that were created or refined using generative AI tools. Nevertheless, the tools used clearly define protocols that ensure the data is not stored, reused, or incorporated into model training.s


- **Non-privacy Preserving AI-Assisted Content (🟠)**: The  document includes sections that were created or refined using generative AI tools. These tools were used without explicit guarantees regarding data retention, reuse, or model training. In most cases, the privacy and future use of the provided data cannot be fully assured.
...
- **AI-Assisted Content Generation (📎)** : The document includes sections or paragraphs generated with the assistance of AI tools. At this level, the authorship remains original but is influenced by generative AI tools. As a result, the generated portions may reflect biases inherent in the sources and training data.


- **AI-Generated Content (⚙️)**: 
The document is entirely generated by generative AI tools, with minimal or no human authorship involved in the creation of the content. Consequently, the output may be influenced by biases present in the AI’s training data, sources, or model assumptions. 
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td rowspan="3">Scientific papers, anonymized research reports, internal documentation, University reports and thesis (Language Editing only).</td>
    </tr>
    <tr>
      <td>
